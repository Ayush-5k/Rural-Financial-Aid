		...
		<div className="flex flex-col md:flex-row h-screen bg-gray-100">
			...
			<div className="flex-1 p-6 overflow-auto">
				...
				<div className="flex flex-col md:flex-row justify-between items-center mb-6">
					{/* Hamburger Menu */}
					<button
						className="md:hidden text-gray-600 mr-4 self-end text-xl"
					...
					{/* Title */}
					<h1 className="text-sm md:text-3xl font-semibold mb-4 md:mb-0">
						All Files
					</h1>
					...
					<div className="flex flex-col md:flex-row gap-4">
						...
						{/* Upload Button */}
						<label className="bg-black text-white py-2 px-4 rounded flex items-center cursor-pointer mb-4 md:mb-0">
							Upload or Drop
							<input
								type="file"
								className="hidden"
						...
						<button className="bg-black text-white py-2 px-4 rounded flex items-center mb-4 md:mb-0">
							Create folder
						</button>
