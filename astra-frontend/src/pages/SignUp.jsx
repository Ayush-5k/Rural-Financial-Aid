	...
	return (
		<div className="min-h-screen bg-black flex flex-col justify-center items-center p-4 relative overflow-hidden">
			...
			<div className="absolute inset-0 z-0">
				<svg
					className="absolute top-10 left-10 text-blue-500 opacity-50 w-16 h-16 md:w-24 md:h-24"
					viewBox="0 0 24 24"
					fill="currentColor"
				>
				...
				<svg
					className="absolute bottom-10 right-10 text-blue-500 opacity-50 w-24 h-24 md:w-32 md:h-32"
					viewBox="0 0 24 24"
					fill="currentColor"
				>
				...
				<svg
					className="absolute top-1/2 left-1/4 text-blue-500 opacity-50 w-12 h-12 md:w-16 md:h-16"
					viewBox="0 0 24 24"
					fill="currentColor"
				>
			...
			<header className="w-full max-w-4xl flex justify-center items-center mb-8 z-10 px-4 md:px-0 space-x-[10%] md:justify-between md:-mt-10">
				<Link to="/" className="text-white">
					<img src="/full-logo.png" alt="AstraPlan" className="h-20" />
				</Link>
          ...
          <Link to="/sign-up" className="hover:text-blue-200 text-sm md:text-base">SIGN UP</Link> */}
				...
				<button className="bg-white text-blue-600 px-3 py-1 md:px-4 md:py-2 rounded-full text-xs md:text-sm font-semibold hover:bg-gray-200 transition duration-300">
					Free Download
				</button>
			</header>
